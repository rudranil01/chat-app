...
import 'package:firebase_project/pages/chat_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //     // nextScreen(context, GroupInfo(groupId: widget.groupId, groupName: widget.groupName, adminName: adminName));
        //
        //
     ...
     // body: Center(
     //   child: Text(
     //     "hello my nigga",style: TextStyle(color: Colors.black,fontSize: 30),
     //   ),
     // ),
    );
      ...
      trailing: InkWell(
        onTap: () async{
          ...
          if(isJoined){
            ...
            setState(() {
              isJoined=!isJoined;
              showSnackBar(context, Colors.red, "group left successfully");
