...
import 'package:firebase_project/pages/group_info.dart';
import 'package:firebase_project/service/database_service.dart';
import 'package:firebase_project/widgets/message_tile.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  sendMessage(){
    ...
    DatabaseService().sendMessage(widget.groupId,chatmap);
    setState(() {
